...
const TotalSales = ({ appliedFilter }) => {
    ...
    const saleSankeyHandler = async () => {
        try {
            const authService = new AuthServices();
            const response = await authService.postApiCallHandler(API_ENDPOINTS.TopSellingSankey, { ...appliedFilter, "groupBy": "productName" });
                ...
                <div className="col-span-2  bg-white rounded-bs flex flex-col border border-neutral-200 ">
                    ...
                    <div className='p-xl pt-s h-full '>
                        ...
                        <div className='flex text-f-m  h-[270px]  flex-col overflow-y-scroll hide-scrollbar bg-white'>
                            {totalSalesOverTime.map((sale, index) => (<div className={clsx(' flex  border-b border-neutral-200  text-neutral-1200', index >= totalSalesOverTime.length - 1 && 'border-b-0')} key={index} >
            ...
            <div className="grid  md:grid-cols-2 lg:grid-cols-2 xl:grid-cols-3 gap-xl mt-xl h-[400px]">
                ...
                <div className="col-span-1 h-full bg-white rounded-bs flex flex-col border border-neutral-200 ">
                    ...
                    <div className='p-xl pt-s '>
                        ...
                        <div className='flex text-f-m  h-[270px]  flex-col overflow-y-scroll hide-scrollbar'>
                            {ordersOverTime.map((order, index) => (<div className={clsx(' flex  border-b border-neutral-200  text-neutral-1200', index >= ordersOverTime.length - 1 && 'border-b-0')} key={index} >
